const listaProyectos = [
  ...
  // Orden: adeahealth - techround - bagu hoteles - ginezen - ciudadania croata - flakkaboem sessions
  // ----------------------------------------------------
  {
    id: "com-adeahealth",
    categoria: "comercial",
    ...
    publicaciones: [
      {
        ...
        año: "2025-2026",
        titulo: "TechRound UK",
        descripcionES: "<p>Producción de contenido audiovisual a partir de noticias, artículos editoriales y entrevistas, adaptado a múltiples formatos y plataformas (YouTube y redes sociales). Trabajo coordinado con equipo editorial y colaboradores externos.</p>",
        descripcionEN: "<p>Production of audiovisual content from news articles, editorials, and interviews adapted to multiple formats and platforms (YouTube and social media). Coordinated work with editorial team and external collaborators.</p>",
        mediaHTML: `
              ...
              <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; width: 100%;">
                ${[
                  ...
                  <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
                    <iframe src="https://www.youtube.com/embed/${id}?playlist=${id}&loop=1" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
                  </div>
                `).join('')}
              </div>
            </div>
    ...
    publicaciones: [
      {
        ...
        `,
        mediaHTML: '<iframe src="https://www.youtube.com/embed/fLpjvvWXApA?playlist=fLpjvvWXApA&loop=1" title="Albores" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
      }
    ]
  },
  {
    ...
    publicaciones: [
      {
        ...
        mediaHTML: '<iframe src="https://www.youtube.com/embed/_fNHM4maVpA?playlist=_fNHM4maVpA&loop=1" title="memoria" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
      }
    ]
  },
  {
    ...
    publicaciones: [
      {
        ...
        mediaHTML: `
          <div style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
              <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
                  <iframe src="https://www.youtube.com/embed/1_h0tL3hrfA?playlist=1_h0tL3hrfA&loop=1" title="Moyo Video 1" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
              </div>
              <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
                  <iframe src="https://www.youtube.com/embed/e0nDvOtpPjM?playlist=e0nDvOtpPjM&loop=1" title="Moyo Video 2" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
              </div>
              <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; width: 100%; margin-top: 15px;">
                  <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
                      <iframe src="https://www.youtube.com/embed/-K0N8nFII5Y?playlist=-K0N8nFII5Y&loop=1" title="Proceso 1" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
                  </div>
                  <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
                      <iframe src="https://www.youtube.com/embed/BC_WIf5bPTQ?playlist=BC_WIf5bPTQ&loop=1" title="Proceso 2" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
                  </div>
                  <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
                      <iframe src="https://www.youtube.com/embed/oUgn8nPFbTo?playlist=oUgn8nPFbTo&loop=1" title="Proceso 3" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
                  </div>
              </div>
          </div>
        `
    ...
    publicaciones: [
      {
        ...
        mediaHTML: `
          <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000; margin-bottom: 25px;">
              <iframe src="https://www.youtube.com/embed/jHQmMj2uQmo?playlist=jHQmMj2uQmo&loop=1" title="cero, nueve" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
          </div>
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; width: 100%;">
    ...
    publicaciones: [
      {
        ...
        mediaHTML: `
          <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
              <iframe src="https://www.youtube.com/embed/GC83fCLqHPs?playlist=GC83fCLqHPs&loop=1" title="Urdimbre" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
          </div>
    ...
    publicaciones: [
      {
        ...
        mediaHTML: `
          <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
              <iframe src="https://www.youtube.com/embed/okDMsnwzYII?playlist=okDMsnwzYII&loop=1" title="Entre las Dos" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
          </div>
    ...
    publicaciones: [
      {
        ...
        mediaHTML: `
          <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
              <iframe src="https://www.youtube.com/embed/ey6VMglwguY?playlist=ey6VMglwguY&loop=1" title="La Grulla" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
          </div>
          <div style="font-family: Google Sans, sans-serif; font-size: 20px; font-weight: 700; color: #000; margin-top: 40px; margin-bottom: 15px;">Backstage:</div>
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; width: 100%;">
    ...
    publicaciones: [
      {
        ...
        `,
        mediaHTML: '<iframe src="https://www.youtube.com/embed/FKYOi1UyxpY?playlist=FKYOi1UyxpY&loop=1" title="Documental del azar" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
      }
    ]
  },
  // ----------------------------------------------------
  ...
  // ----------------------------------------------------
  {
    id: "free-audiovisual-production",
    categoria: "freelance",
    portadaImg: "img/portadas/portada-audiovisual-production.png",
    publicaciones: [
      {
        idPub: "free-ap-p1",
        año: "-",
        ...
        mediaHTML: `
          <div style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
            <div style="position: relative; width: 100%; padding-top: 56.25%; overflow: hidden; border-radius: 4px; background-color: #000;">
              <iframe src="https://www.youtube.com/embed/1PhbdwkZGWA" title="Anhedonia" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;"></iframe>
            </div>
            <div style="display: flex; flex-direction: column; gap: 15px; width: 100%;">
              <img data-lightbox="true" src="img/proyectos-internos/audiovisual-production-1.png" style="width: 100%; height: auto; border-radius: 4px; cursor: pointer;">
              <img data-lightbox="true" src="img/proyectos-internos/audiovisual-production-2.png" style="width: 100%; height: auto; border-radius: 4px; cursor: pointer;">
            </div>
          </div>
        `
      }
  ...
  },
  {
    ...
    categoria: "freelance",
    portadaImg: "img/portadas/portada-graphic-design.png",
    publicaciones: [
      {
        idPub: "free-gd-p1",
        año: "-",
        ...
        mediaHTML: `
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; width: 100%;">
            ${[1, 2, 3, 4, 5].map(num => `
              <img data-lightbox="true" src="img/proyectos-internos/graphic-design-${num}.png" style="width: 100%; height: auto; object-fit: cover; cursor: pointer; border-radius: 4px;">
            `).join('')}
          </div>
        `
      }
  ...
  // ----------------------------------------------------
  // INSTALACIONES
  // Orden: primero Bajo Sur, después Periferias
  // ----------------------------------------------------
  {
    id: "inst-bajo-sur",
